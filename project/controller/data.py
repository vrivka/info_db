...
def import_table(table_name: str,
    ...
    if not imported_file.filename.endswith(".csv"):
        ...
        db.truncate_cascade(pd)
        db.call_procedure(pd, params)
